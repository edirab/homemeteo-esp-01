...
5. Про переносе файла с windows на linux могут слететь окончания строк: `dos2unix <file>`
6. Для отладки пользоваться гайдом [отсюда](https://stackoverflow.com/questions/22743548/cronjob-not-running)
